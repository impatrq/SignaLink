/* Signalink BLE GATT Server */ // This code is part of the Signalink project.
...
/// Declaro las funciones estaticas para el manejo de eventos GATT
...
static char test_device_name[ESP_BLE_ADV_NAME_LEN_MAX] = "ESP_SIGNALINK_SERVER";
